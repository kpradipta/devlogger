...
type LogServiceClient interface {
	SendLog(ctx context.Context, in *LogEntry, opts ...grpc.CallOption) (*Empty, error)
	GetLogs(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*LogList, error)
}
...
func (c *logServiceClient) SendLog(ctx context.Context, in *LogEntry, opts ...grpc.CallOption) (*Empty, error) {
...
func (c *logServiceClient) GetLogs(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*LogList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogList)
...
type LogServiceServer interface {
	SendLog(context.Context, *LogEntry) (*Empty, error)
	GetLogs(context.Context, *QueryRequest) (*LogList, error)
...
func (UnimplementedLogServiceServer) SendLog(context.Context, *LogEntry) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendLog not implemented")
}
func (UnimplementedLogServiceServer) GetLogs(context.Context, *QueryRequest) (*LogList, error) {
...
func _LogService_GetLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogServiceServer).GetLogs(ctx, req.(*QueryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LogService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/logger.proto",
}
